    ...
    <div className="max-w-4xl mx-auto space-y-8">
      <div>
        ...
        <p className="text-gray-600 mt-2">
          Upload and manage your brochure templates
        </p>
      </div>
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="mt-2 border-2 border-dashed border-gray-300 rounded-xl p-12 text-center hover:border-primary/50 transition-colors">
                ...
                <p className="text-xs text-gray-500 mt-3">
                  Supports: PDF, AI, PSD, SVG, JPG, JPEG, PNG, GIF, WEBP (Max
                  50MB)
                </p>
              </div>
              {selectedFile && (
            ...
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">
                Default footer color for this template
              </p>
            </div>
            ...
            <Button
              ...
              disabled={
                !selectedFile || !templateName || uploadMutation.isPending
              }
              className="w-full"
            >
