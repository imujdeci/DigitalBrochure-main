...
export interface IStorage {
  ...
  addProductToCampaign(
    campaignProduct: InsertCampaignProduct
  ): Promise<CampaignProduct>;
  updateCampaignProduct(
    id: number,
    updates: Partial<CampaignProduct>
  ): Promise<CampaignProduct | undefined>;
...
export class MemStorage implements IStorage {
    ...
    const sampleProducts: Product[] = [
      {
        ...
        imageUrl:
          "https://images.unsplash.com/photo-1505740420928-5e560c06d30e?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
      ...
      },
      {
        ...
        imageUrl:
          "https://images.unsplash.com/photo-1511707171634-5f897ff02aa9?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
      ...
      },
      {
        ...
        imageUrl:
          "https://images.unsplash.com/photo-1603302576837-37561b2e2302?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
      ...
      },
      {
        ...
        imageUrl:
          "https://images.unsplash.com/photo-1523275335684-37898b6baf30?ixlib=rb-4.0.3&auto=format&fit=crop&w=300&h=300",
  ...
  async getCampaignProducts(campaignId: number): Promise<CampaignProduct[]> {
    return Array.from(this.campaignProducts.values()).filter(
      (cp) => cp.campaignId === campaignId
    );
  }

  async addProductToCampaign(
    insertCampaignProduct: InsertCampaignProduct
  ): Promise<CampaignProduct> {
  ...
  async createTemplate(insertTemplate: InsertTemplate): Promise<Template> {
    ...
    const template: Template = {
      ...
      footerColor: insertTemplate.footerColor || null,
  ...
  async getLogos(userId: number): Promise<Logo[]> {
    return Array.from(this.logos.values()).filter(
      (logo) => logo.userId === userId
    );
  }

  async getActiveLogo(userId: number): Promise<Logo | undefined> {
    return Array.from(this.logos.values()).find(
      (logo) => logo.userId === userId && logo.isActive
    );
  }
  ...
  async setActiveLogo(userId: number, logoId: number): Promise<boolean> {
    ...
    const userLogos = Array.from(this.logos.values()).filter(
      (logo) => logo.userId === userId
    );
